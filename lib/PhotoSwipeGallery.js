...
var PhotoSwipeGallery = function (_React$Component) {
  ...
  function PhotoSwipeGallery() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = PhotoSwipeGallery.__proto__ || Object.getPrototypeOf(PhotoSwipeGallery)).call.apply(_ref, [this].concat(args))), _this), _this.thumbnails = [], _this.state = {
      isOpen: _this.props.isOpen,
      options: _this._initOptions()
    }, _this._initOptions = function () {
      var _this$props$options = _this.props.options,
          options = _this$props$options === undefined ? {} : _this$props$options;

      return Object.assign({ getThumbBoundsFn: _this.getThumbBoundsFn }, options);
    }, _this.getThumbBoundsFn = function (index) {
    ...
    }, _this.showPhotoSwipe = function (index) {
      return function (e) {
        e.preventDefault();
        _this.setState(function (prevState) {
          return {
            isOpen: true,
            options: _extends({}, prevState.options, { index: index })
          };
        });
      };
